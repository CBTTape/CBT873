...
//*       look.  These were updated for ULUT Type 3, and            *   FILE 873
//*       their appearance is similar to Type 2.  See               *   FILE 873
//*       member ULUSAMP4 for (the beginning of) a ULUT             *   FILE 873
//*       Type 3.  The 31-bit ULUT is pointed to by +X'8'           *   FILE 873
//*       in the IOVT.  The 64-bit ULUT is pointed to by            *   FILE 873
//*       the 64-bit address at X'1B8' off the IOVT.  If            *   FILE 873
//*       the address X'8' off the IOVT is zeroes, then             *   FILE 873
//*       that is a proof that we have a 64-bit ULUT.               *   FILE 873
//*                                                                 *   FILE 873
//*       IOVT is undocumented by IBM, but it is documented         *   FILE 873
//*       by SHOWMACS in CBT File 492.  Getting to the IOVT         *   FILE 873
//*       is documented by IBM, using the following code:           *   FILE 873
//*                                                                 *   FILE 873
//*           L     R2,16                                           *   FILE 873
//*           USING CVTMAP,R2                                       *   FILE 873
//*           DROP  R2                                              *   FILE 873
//*           L     R3,X'7C'(,R2)      CVTIXAVL - IOCOM             *   FILE 873
//*           L     R3,X'D0'(,R3)      IOS Vector Table (IOVT)      *   FILE 873
//*                                                                 *   FILE 873
...
//*                                                                 *   FILE 873
//*       ULUONLN  - Displays all online devices AND THEIR REAL     *   FILE 873
//*                  UCB's WITHOUT BEING APF-AUTHORIZED.  Very      *   FILE 873
//*                  valuable if you want to know the read UCB's.   *   FILE 873
//*                                                                 *   FILE 873
